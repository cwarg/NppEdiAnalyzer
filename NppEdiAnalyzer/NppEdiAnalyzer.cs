    ...
    class Main
    {
        ...
        public static void OnNotification(ScNotification notification)
        {
            ...
            */
            ...
            if (notification.Header.Code != (uint)SciMsg.SCN_DOUBLECLICK) return;
            try
            {
...
namespace Kbg.Demo.Namespace
{
    ...
    <UserLang name=""X12"" ext="""">
        ...
        <KeywordLists>
            ...
            <Keywords name=""Words1"">ISA IEA GS GE ST SE BIG</Keywords>
        ...
        <Styles>
            ...
            // Find out if there is a way to automatically restart NPP
        }
